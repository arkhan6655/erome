			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Locations Sitemap - Methstreams.World</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - Methstreams.World</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="http://localhost/erome/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
